...
urlpatterns = [
    ...
    path("<int:project_pk>/todo/<int:pk>/", views.Tododetail.as_view()),
    path("<int:project_pk>/todo/<int:todo_pk>/comments/", views.comment),
    path("<int:project_pk>/todo/<int:todo_pk>/comments/create/", views.comment_create),
    path("<int:project_pk>/todo/<int:todo_pk>/comments/<int:comment_pk>/", views.comment_update_and_delete),
